...
/*   Updated: 2021/05/12 16:45:05 by lzylberm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strjoin(char const *s1, char const *s2)
{
	...
	s1_cpy = (char *)s1;
	s2_cpy = (char *)s2;
	str = ft_strnew(ft_strlen(s1_cpy) + ft_strlen(s2_cpy));
	if (str == NULL)
		return (NULL);
	while (index < (int)ft_strlen(s1_cpy))
	{
		str[index] = s1_cpy[index];
		index++;
	}
	while (index < (int)(ft_strlen(s1_cpy) + ft_strlen(s2_cpy)))
	{
		str[index] = s2_cpy[index - ft_strlen(s1_cpy)];
		index++;
	}
	return (str);
}
